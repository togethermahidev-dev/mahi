...
BEGIN
  ...
  -- Rest day check: fitness_routine = comma-separated 3-letter abbrevs e.g. 'Mon,Wed,Fri'
  -- Days absent from the list are rest days; uploading on a rest day extends the streak
